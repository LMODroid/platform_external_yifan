...
public class MainActivity extends AppCompatActivity {
    ...
    private void bindPreview(@NonNull ProcessCameraProvider cameraProvider) {
        ...
        CameraSelector cameraSelector =
                new CameraSelector.Builder().requireLensFacing(selectedCamera).build();
        ...
        imageAnalysis.setAnalyzer(
                ...
                imageProxy -> {
                    ...
                    List<FaceRecognizer.Face> data =
                            faceRecognizer.recognize(BitmapUtils.getBitmap(imageProxy));
                    ...
                    for (FaceRecognizer.Face face : data) {
                        ...
                        if (face.isRecognized()) {
                            ...
                            // Show detected object type (always "Face") and how confident the AI is
                            // that this is a Face
