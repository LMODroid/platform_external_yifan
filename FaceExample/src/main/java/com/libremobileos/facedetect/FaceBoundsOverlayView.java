...
public class FaceBoundsOverlayView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (bounds == null || transform == null || paint == null) return; // am I ready yet?
    ...
    public void updateBounds(
            List<Pair<RectF, String>> inputBounds, int sensorWidth, int sensorHeight) {
        ...
        if (this.sensorWidth != sensorWidth
            ...
            transform =
                    ImageUtils.getTransformationMatrix(
                            sensorWidth, sensorHeight, viewWidth, viewHeight, 0, false);
            viewWidth = 0;
            viewHeight = 0;
        }
